Конспект по книге Адитья Бхаргава "Грокаем Алгоритмы".

## BASE

__logarithm__
	Противоположен по смыслу возведению в степень.
	...
	Для сокращения записи Log по основанию 2 всегда записывается как просто Log
	Log^2 == Log
