...
Примеры:
<blockquote>
<br>Log^10 100 = сколько раз нужно перемножить 10 чтобы получилось 100 ?
<br>Log^2 N = сколько раз нужно перемножить 2 чтобы получилось N ?
</blockquote>

Примечание:
</blockquote>
<br>Для сокращения записи Log по основанию 2 всегда записывается как просто Log (Log^2 == Log)
</blockquote>
...
Пример:
<br>*Линейный алгоритм поиска* - O (N)
